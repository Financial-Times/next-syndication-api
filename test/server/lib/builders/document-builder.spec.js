...
describe(MODULE_ID, function () {
    ...
    beforeEach(function() {
        content = require(path.resolve(`${FIXTURES_DIRECTORY}/content/${CONTENT_ID}.json`));
        content.lang = 'en';
    ...
    describe('constructor', function() {
        ...
        it('has contentDocument', function(){
            expect(documentBuilder.contentDocument.constructor.name).to.equal('Document');
        });
    });

    describe('removeElementsByTagName', function(){
        it('is function', function(){
            expect(typeof documentBuilder.removeElementsByTagName).to.equal('function');
        });
    });
    describe('removeProprietaryElement', function(){
        it('is function', function(){
            expect(typeof documentBuilder.removeProprietaryElement).to.equal('function');
        });
    });
    describe('removeWhiteSpace', function(){
        it('is function', function(){
            expect(typeof documentBuilder.removeWhiteSpace).to.equal('function');
        });
    });
    describe('removeNonSyndicatableImages', function(){
        it('is function', function(){
            expect(typeof documentBuilder.removeNonSyndicatableImages).to.equal('function');
        });
    });
