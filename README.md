...
There is a [JSON export of a Postman collection](docs/syndication-api-postman.json) that gives you an easy way to run all the endpoints that this API provides to run syndication, as well as some endpoints to troubleshoot and trigger workers jobs.
